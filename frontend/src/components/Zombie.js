...
const Zombie = (props) => {
    const [skinColor, setSkinColor] = useState(99);
    const [eyeColor, setEyeColor] = useState(100);
    const [clothesColor, setClothesColor] = useState(222);

    useEffect(() => {
        setSkinColor(props.skinColor);
        setEyeColor(props.eyeColor);
        setClothesColor(props.clothesColor);
    }, [props])

    return (
        <div className={"zombie-preview"}>
            <div className={"zombie-parts head-visible-2 eye-visible-1 shirt-visible-3"}>
                <img src={catLegs} className="cat-legs" alt="" style={{filter: `hue-rotate(${clothesColor}deg)`}}/>
                <img src={leftFeet} className="left-feet" alt="" style={{filter: `hue-rotate(${clothesColor}deg)`}}/>
                <img src={rightFeet} className="right-feet" alt="" style={{filter: `hue-rotate(${clothesColor}deg)`}}/>
                <img src={leftLeg} className="left-leg" alt="" style={{filter: `hue-rotate(${clothesColor}deg)`}}/>
                <img src={rightLeg} className="right-leg" alt="" style={{filter: `hue-rotate(${clothesColor}deg)`}}/>
                <img src={leftThigh} className="left-thigh" alt="" style={{filter: `hue-rotate(${clothesColor}deg)`}}/>
                <img src={rightThigh} className="right-thigh" alt=""
                     style={{filter: `hue-rotate(${clothesColor}deg)`}}/>

                <img src={rightUpperArm} className="right-upper-arm" alt=""
                     style={{filter: `hue-rotate(${skinColor}deg)`}}/>
                <img src={torso} className="torso" alt="" style={{filter: `hue-rotate(${clothesColor}deg)`}}/>
                <ZombieShirt clothesColor={clothesColor}/>
                <img src={leftUpperArm} className="left-upper-arm" alt=""
                     style={{filter: `hue-rotate(${skinColor}deg)`}}/>
                <img src={leftForeArm} className="left-forearm" alt="" style={{filter: `hue-rotate(${skinColor}deg)`}}/>
                <img src={rightForeArm} className="right-forearm" alt=""
                     style={{filter: `hue-rotate(${skinColor}deg)`}}/>
                <img src={leftHand} className="left-hand" alt="" style={{filter: `hue-rotate(${skinColor}deg)`}}/>
                <img src={rightHand} className="right-hand" alt="" style={{filter: `hue-rotate(${skinColor}deg)`}}/>
...
const ZombieShirt = (props) => {
    const clothesStyle = {
        filter: `hue-rotate(${props.clothesColor}deg)`
    }
    return (
        <>
...
const ZombieHead = (props) => {
    const headStyle = {
        filter: `hue-rotate(${props.skinColor}deg)`
    }
    return (
        <>
...
const ZombieEye = (props) => {
    const eyeStyle = {
        filter: `hue-rotate(${props.eyeColor}deg)`
    }
    return (
        <>
